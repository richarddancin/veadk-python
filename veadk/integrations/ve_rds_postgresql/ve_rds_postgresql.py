...
class VeRdsPostgresqlException(Exception):
...
class VeRdsPostgresqlClient:
    ...
    def _request(self, action: str, request_body: dict):
        ...
        if "ResponseMetadata" in response and "Error" in response["ResponseMetadata"]:
            ...
            raise VeRdsPostgresqlException(
    ...
    def describe_db_instance_detail(self, instance_id):
        """Get detailed information about a specific RDS PostgreSQL instance.
    ...
    def describe_databases(self, instance_id, db_name=None):
        """List databases on a specific RDS PostgreSQL instance.
    ...
    def describe_accounts(self, instance_id, account_name=None):
        """List accounts on a specific RDS PostgreSQL instance.
    ...
    def create_database(self, instance_id, db_name, character_set_name="UTF8"):
        """Create a database on a specific RDS PostgreSQL instance.

        Args:
            instance_id: The ID of the DB instance
            db_name: Name of the database to create
            character_set_name: Character set (default: UTF8)
    ...
    def create_account(
        ...
        """Create an account on a specific RDS PostgreSQL instance.
    ...
    def get_connection_info(self, instance_id):
        """Get connection information for an RDS PostgreSQL instance.
        ...
        for ep in endpoints:
            addresses = ep.get("Address", [])
            for addr in addresses:
                if addr.get("NetworkType") == "Private":
                    private_endpoint = addr
                elif addr.get("NetworkType") == "Public":
        ...
        return {
            ...
            "port": endpoint.get("Port") if endpoint else 5432,
